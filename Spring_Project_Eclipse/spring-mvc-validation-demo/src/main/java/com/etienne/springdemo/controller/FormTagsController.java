...
import com.etienne.springdemo.domain.test.OrganizationRegistration;
import com.etienne.springdemo.service.test.OrganizationRegistrationService;
...
public class FormTagsController {
	...
	public void populateFormObjectWithData(Model model) {
		...
		map.put("employeeStrengthList", orgRegService.populateEmployeesStrength());
	}
}
